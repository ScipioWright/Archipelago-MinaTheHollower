...
transitions: dict[str, Transition] = {
    ...
    "Mourner's Mile Knight's Guard Bike Mina's Grave Door": Transition("Mourner's Mile Knight's Guard Bike", "Mourner's Mile Mina's Grave", DirectionType.NORTH, TransitionType.DOORS, CanJumpTiles(distance=2) & HasSparks(count=3)),
